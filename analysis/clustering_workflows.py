"""
Clustering class from OpenCell for Leiden Clustering
"""
import collections
...
class ClusteringWorkflow:
    ...
    def calculate_neighbors(self, n_pcs=200, use_rep=None, n_neighbors=10, metric='euclidean'):
        '''
    ...
    def calculate_ari(self, ground_truth_label, model_name, n_random_states=3, res=0.2):
        '''
        ...
        Result = collections.namedtuple(
            'result', 
            ['resolution', 'random_state', 'num_clusters', 'median_cluster_size', 'ari', 'ami', 'model']
        )

        # only use targets that are in a single ground-truth cluster
        mask = self.adata.obs[ground_truth_label] != 'other'
